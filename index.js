...
const config = {
    XBOT: '❉FARREL GANTENG❉', 
    instagram: 'https://instagram.com/farrel.a.r08?igshid=whuvk9fhks1', 
    nomer: 'wa.me/6281213769983',
    youtube: 'https://youtube.com/channel/UC90Udf1_nsl_JiVmPsvDr8g', 
...
client.on('group-participants-update', async (anu) => {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["6281213769983@s.whatsapp.net"] 
          ...
          case 'ping':
            ...
            case 'kangcopet':
                ...
                case 'bug':
                    ...
                    client.sendMessage('6281213769983@s.whatsapp.net', options, text, {quoted: mek})
